...
function M.git_component()
	return string.format("%%#StatuslineTitle#%s%s", (vim.b.minigit_summary_string and string.format(" %s" , vim.b.minigit_summary_string) or ""),	(vim.b.minidiff_summary_string or ""))
end
...
vim.api.nvim_create_autocmd("LspProgress", {
	group = vim.api.nvim_create_augroup("dots_nvim/statusline", { clear = true }),
