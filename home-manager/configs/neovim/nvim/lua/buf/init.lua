...
local createTab = function(buf)
	...
	local name, ext = vim.fn.fnamemodify(filename, ":t"), vim.fn.fnamemodify(filename, ":e")
...
M.setup = function()
	if #vim.fn.getbufinfo({ buflisted = 1 }) >= 1 then
		vim.o.showtabline = 2
		vim.o.tabline = '%!v:lua.require("buf").getTabline()'
	end
end
vim.cmd([[
